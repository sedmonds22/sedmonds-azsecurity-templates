...
var azureActivityContent = loadTextContent('../../../content/workbooks/AzureActivity.json')
var serviceHealthContent = loadTextContent('../../../content/workbooks/AzureServiceHealthWorkbook.json')
var entraAuditContent = loadTextContent('../../../content/workbooks/AzureActiveDirectoryAuditLogs.json')
var entraSigninContent = loadTextContent('../../../content/workbooks/AzureActiveDirectorySignins.json')
